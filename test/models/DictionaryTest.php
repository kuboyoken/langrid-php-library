...
class DictionaryTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testRmove_language() {
        ...
        $beforeContentsCount = count(DictionaryContent::find_all_by_dictionary_id(5));

        $dict->remove_language(Language::get('ja'));
        $afterCount = count($dict->get_languages());
        $afterContentsCount = count(DictionaryContent::find_all_by_dictionary_id(5));
    ...
    public function testUpdate_language(){
        ...
        $beforeContentCount = count(DictionaryContent::find_all_by_dictionary_id(7));
        $dict->update_languages(array('ja', 'en', 'vi'));
        $langs = $dict->get_languages();
        $afterContentCount = count(DictionaryContent::find_all_by_dictionary_id(7));
    ...
    public function testRmove_language_force() {
        ...
        $beforeCount = count($dict->get_languages(array('joins' => 'dictionary_records')));
        $beforeContentsCount = count(DictionaryContent::find_all_by_dictionary_id(6));

        $dict->remove_language(Language::get('ja'), true);
        $afterCount = count($dict->get_languages());
        $afterContentsCount = count(DictionaryContent::find_all_by_dictionary_id(6));
